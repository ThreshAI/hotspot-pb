...
func (c *hotspotServiceClient) GetHotspots(ctx context.Context, in *HotspotRequest, opts ...grpc.CallOption) (*HotspotResponse, error) {
	...
	err := c.cc.Invoke(ctx, HotspotService_GetHotspots_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedHotspotServiceServer must be embedded to have forward compatible implementations.
